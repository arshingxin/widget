...
/**
 * 自訂超連結TextView
 * PS: 主要處理當TextView是ListView Item的時候，TextView又有超連結，ListView的Item Click會失效
 * @author Star
 */
public class CustomAutoLinkTextView extends TextView{

    public CustomAutoLinkTextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public CustomAutoLinkTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public CustomAutoLinkTextView(Context context) {
        super(context);
        init();
    }
